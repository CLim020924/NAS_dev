const SURFACES = Object.freeze({
  ...
  files: ['list_files', 'search_files', 'list_image_files', 'read_text_file', 'get_file_properties', 'list_trash', 'list_file_versions', 'list_drive_restore_points', 'list_activity', 'list_favorites', 'list_recent_files', 'restore_trash_item', 'restore_file_version', 'create_drive_restore_point', 'restore_drive_restore_point', 'set_file_favorite', 'create_folder', 'write_text_file', 'create_document', 'append_text_file', 'copy_item', 'move_item', 'trash_item', 'organize_files_by_modified_date', 'create_zip_bundle'],
  ...
  notes: ['list_notebooks', 'get_python_runtime', 'list_notes', 'read_note', 'list_deleted_notes', 'list_note_versions', 'create_notebook', 'create_note', 'update_note', 'trash_note', 'restore_note', 'restore_note_version', 'attach_note_item', 'remove_note_attachment', 'create_office_document', 'run_python_note', 'run_javascript_note'],
...
const classifyPlatformRoute = (routePath, method = 'GET') => {
  ...
  if (route === '/icons' || route === '/check-access' || route === '/access-history') return 'file-ui';
