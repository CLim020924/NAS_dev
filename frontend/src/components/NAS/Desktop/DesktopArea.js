    ...
    >
      ...
      >
        <Box sx={{
          p: 1,
          borderRadius: '6px',
          border: selectedItems.includes('system_root') ? `1px solid ${theme.palette.mode === 'dark' ? 'rgba(255,255,255,0.28)' : 'rgba(15,23,42,0.18)'}` : '1px solid transparent',
          backgroundColor: selectedItems.includes('system_root') ? (theme.palette.mode === 'dark' ? 'rgba(255,255,255,0.08)' : 'rgba(15,23,42,0.08)') : 'transparent',
